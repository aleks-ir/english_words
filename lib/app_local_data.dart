...
class AppLocalData {
  ...
  void initLocalData(Box settingsBox) async {
    ...
    if (!settings.hasLocalData) {
      ...
      await createUpdateHistoryUsecase(History(date: '2022-03-25', wordExploredCount: 10));
      await createUpdateHistoryUsecase(History(date: '2022-03-26', wordExploredCount: 15));
      await createUpdateHistoryUsecase(History(date: '2022-03-27', wordExploredCount: 1));
      await createUpdateHistoryUsecase(History(date: '2022-03-28', wordExploredCount: 4));
      await createUpdateHistoryUsecase(History(date: '2022-03-30', wordExploredCount: 9));
      await createUpdateHistoryUsecase(History(date: '2022-04-02', wordExploredCount: 6));
    }
